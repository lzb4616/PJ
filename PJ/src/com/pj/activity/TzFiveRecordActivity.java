...
public class TzFiveRecordActivity extends Activity implements SurfaceHolder.Callback{
	...
	private static final String TAG = "TzFiveRecordActivity";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		change_photo_record_btn.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				Intent i = new Intent();
				i.setClass(TzFiveRecordActivity.this, TzFivePhotoActivity.class);
				startActivity(i);
				finish();
	...
	private class ChangeTzToPjListener implements OnClickListener {
		...
		public void onClick(View v) {
			if (v.getId() == R.id.space_change) {
				Intent i = new Intent();
				i.setClass(TzFiveRecordActivity.this, PJPhotoActivity.class);
				startActivity(i);
				finish();
			}
	...
	private class ChangeFourOrFiveListener implements OnClickListener {
		...
		public void onClick(View v) {
			if (v.getId() == R.id.pj_or_tongzi) {
				Intent i = new Intent();
				i.setClass(TzFiveRecordActivity.this, TzFourPhotoActivity.class);
				startActivity(i);
				finish();
			}
		}
