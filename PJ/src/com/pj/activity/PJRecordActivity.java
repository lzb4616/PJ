...
public class PJRecordActivity extends Activity implements SurfaceHolder.Callback{
	private static final String TAG = "PJRecordActivity";
	/**
	 * 屏幕键盘输入数
	 */
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// =========================================================================
				...
				change_photo_record_btn.setOnClickListener(new OnClickListener() {
					public void onClick(View v) {
						Intent i = new Intent();
						i.setClass(PJRecordActivity.this, PJPhotoActivity.class);
						startActivity(i);
						finish();
	...
	private class ChangePjToTzListenser implements OnClickListener {
		...
		public void onClick(View v) {
			if(v.getId() == R.id.space_change){				
				Intent i = new Intent();
				i.setClass(PJRecordActivity.this, TzFourPhotoActivity.class);
				startActivity(i);
				finish();				
			}
